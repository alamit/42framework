...
/*   Updated: 2018/09/27 16:19:24 by alamit           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/test42f.h"

int		test42f_int_eq(char *title, int nb, int expected)
{
	char	*trace;
	int		res;
...
int		test42f_int_neq(char *title, int nb, int expected)
{
	char	*trace;
	int		res;
...
int		test42f_int_lteq(char *title, int nb, int expected)
{
	char	*trace;
	int		res;
...
int		test42f_int_gteq(char *title, int nb, int expected)
{
	char	*trace;
	int		res;
...
int		test42f_int_lt(char *title, int nb, int expected)
{
	char	*trace;
	int		res;
...
int		test42f_int_gt(char *title, int nb, int expected)
{
	char	*trace;
	int		res;
